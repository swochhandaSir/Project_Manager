...
function Login() {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "text-center mb-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-center mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "bg-blue-500 p-4 rounded-lg shadow-md transform rotate-3" }, /* @__PURE__ */ React.createElement(LogIn, { className: "w-8 h-8 text-white" }))), /* @__PURE__ */ React.createElement(
        "h1",
        {
      ...
      )), /* @__PURE__ */ React.createElement(Button, { type: "submit", className: "w-full bg-blue-500 hover:bg-blue-600" }, "Sign In")),
      ...
      /* @__PURE__ */ React.createElement("div", { className: "mt-6 p-4 bg-white/60 rounded-md border-2 border-black/10" }, /* @__PURE__ */ React.createElement(
        "p",
        {
        ...
        "Demo credentials:"
      ), /* @__PURE__ */ React.createElement("p", { className: "text-base", style: { fontFamily: "Indie Flower, cursive" } }, "Email: john@example.com"), /* @__PURE__ */ React.createElement("p", { className: "text-base", style: { fontFamily: "Indie Flower, cursive" } }, "Password: password123"))
    )
  );
}
export {
